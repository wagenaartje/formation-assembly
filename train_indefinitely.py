...
while True:
    ...
    os.mkdir('./runs/{0}/'.format(timestamp))
    fitness_file = open('./runs/{0}/f_{1}.dat'.format(timestamp, settings_str),mode='wb+')
    genome_file = open('./runs/{0}/g_{1}.dat'.format(timestamp, settings_str),mode='wb+')
