...
for subfolder in subfolders:
    ...
    elif config['n_hidden'] == 8:
        fitnesses = np.pad(fitnesses, (0,-fitnesses.shape[0] + epochs.shape[0]), mode='constant', constant_values=fitnesses[-1])
...
for key in all_fitnesses:
    ...
    ax.semilogy(epochs, f_mean, label=r'$h={0}$'.format(key))
